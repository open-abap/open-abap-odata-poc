CLASS zcl_zsegw_mpc DEFINITION
  PUBLIC
  INHERITING FROM zcl_mgw_push_abs_model
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ts_text_element,
            ...
            text_symbol          TYPE zoao_textpoolky,
          END OF ts_text_element.
    TYPES tt_text_elements TYPE STANDARD TABLE OF ts_text_element WITH KEY text_symbol.

    CONSTANTS gc_zsegw TYPE zif_mgw_med_odata_types=>ty_e_med_entity_name VALUE 'zsegw' ##NO_TEXT.
...
CLASS zcl_zsegw_mpc IMPLEMENTATION.
  ...
  METHOD define_zsegw.
    ...
    DATA:
        lo_annotation     TYPE REF TO zif_mgw_odata_annotation,                "#EC NEEDED
        lo_entity_type    TYPE REF TO zif_mgw_odata_entity_typ,                "#EC NEEDED
        lo_complex_type   TYPE REF TO zif_mgw_odata_cmplx_type,                "#EC NEEDED
        lo_property       TYPE REF TO zif_mgw_odata_property,                  "#EC NEEDED
        lo_entity_set     TYPE REF TO zif_mgw_odata_entity_set.                "#EC NEEDED
...
***********************************************************************************************************************************
    ...
    lo_property->zif_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      iv_key   = 'unicode'
      iv_value = 'false' ).
