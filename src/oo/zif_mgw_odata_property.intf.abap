INTERFACE zif_mgw_odata_property PUBLIC.

  INTERFACES zif_mgw_odata_annotatabl.
  INTERFACES zif_mgw_odata_item.

  ALIASES set_label_from_text_element
    FOR zif_mgw_odata_item~set_label_from_text_element.
