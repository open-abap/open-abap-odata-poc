...
* todo,
  ...
  METHOD data.
    ...
    DATA lt_filter_option   TYPE zoao_t_mgw_select_option.
    DATA ls_paging          TYPE zoao_s_mgw_paging.
    DATA lt_key_tab         TYPE zoao_t_mgw_name_value_pair.
    DATA lt_navigation_path TYPE zoao_t_mgw_navigation_path.
    DATA lt_order           TYPE zoao_t_mgw_sorting_order.
...
* todo
  ...
  METHOD metadata.
    ...
    DATA lt_entity_types TYPE STANDARD TABLE OF zif_mgw_med_odata_types=>ty_e_med_entity_name WITH DEFAULT KEY.
    DATA lv_entity_type  LIKE LINE OF lt_entity_types.
    DATA lo_entity       TYPE REF TO zif_mgw_odata_entity_typ.
    DATA lt_properties   TYPE zif_mgw_med_odata_types=>ty_t_mgw_odata_properties.
