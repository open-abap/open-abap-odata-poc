CLASS zcl_oao_model DEFINITION PUBLIC.
  PUBLIC SECTION.
    INTERFACES zif_mgw_odata_model.
  PRIVATE SECTION.
    DATA mv_namespace TYPE string.

    TYPES: BEGIN OF ty_entity,
             entity_name TYPE zif_mgw_med_odata_types=>ty_e_med_entity_name,
             entity      TYPE REF TO zif_mgw_odata_entity_typ,
           END OF ty_entity.
...
CLASS zcl_oao_model IMPLEMENTATION.
  ...
  METHOD zif_mgw_odata_model~create_entity_type.
  ...
  METHOD zif_mgw_odata_model~get_entity_type.
  ...
  METHOD zif_mgw_odata_model~set_schema_namespace.
    mv_namespace = iv_namespace.
  ENDMETHOD.

  METHOD zif_mgw_odata_model~get_schema_namespace.
